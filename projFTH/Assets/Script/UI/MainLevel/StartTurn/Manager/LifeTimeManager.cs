...
namespace Script.UI.MainLevel.StartTurn.Manager
{
    public class LifeTimeManager : MonoBehaviour //, IPointerEnterHandler
    {
        ...
        private Dictionary<GameObject, bool> _isDayTimeSelect = new(); // 해당 날짜와 시간대가 선택되어있는지 확인하는 딕셔너리
        ...
        private void initDayTime()
        {
            for (int i = 1; i <= 20; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    ...
                    {
                        case 0:
                            objectName = "Day" + i + "Moning";
                            break;
                        case 1:
                            objectName = "Day" + i + "Afetnoon";
                            break;
                        case 2:
                    ...
                    _isDayTimeSelect[imageObject] = false;
                }
            }
        }
