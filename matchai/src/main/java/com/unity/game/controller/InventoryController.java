...
public class InventoryController {
    ...
    //유저의 현금 들고옴
    @GetMapping("/cash")
    public Map<String, Object> GetUserInfoFromDB() {
        String param = "ejwhdms502";
        return inventoryService.GetUserInfoFromDB(param);
    }

    @GetMapping("/list")
    public List<Map<String, Object>> GetInventoryList() {
        List<Map<String, Object>> inventoryList = inventoryService.GetInventoryList();
